  ...
  useEffect(() => {
    axios.get(`${youtubeUserEndpoint}?part=snippet&mine=true`, { headers: { Authorization: "Bearer " + accessToken } })
      .then(response => {
        ...
        axios.get(`${youtubePlaylistEndpoint}?part=snippet,status,contentDetails&mine=true&maxResults=50&pageToken=${pageToken}`, { headers: { Authorization: "Bearer " + accessToken } })
